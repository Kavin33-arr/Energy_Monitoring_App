            ...
            <ResponsiveContainer width="100%" height={200} style={{ backgroundColor: 'rgba(0, 0, 0, 0)' }}>
                <PieChart background={{ fill: 'none' }}>
                    ...
                    >
                        ...
                        <Label value={`${data[0].value}2000`} position="center" fill={COLOR} fontSize={30} fontStyle="italic" />
                        <Label value={`${data[0].name}`} position="center" fill={COLOR} fontSize={20} dy={30} fontStyle="italic" fontWeight={200} />
                    </Pie>
                    <style>
